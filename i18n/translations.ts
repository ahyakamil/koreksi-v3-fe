...
const translations: Translations = {
  id: {
    ...
    share_story_placeholder: 'Bagikan cerita atau konten terkini...',
    ...
    news_not_found: 'Konten tidak ditemukan',
    ...
    failed_to_review_news: 'Gagal meninjau konten',
    ...
    joining: 'Bergabung...',
    manage_news: 'Kelola Konten',
    members: 'Anggota',
    my_organizations: 'Organisasi Saya',
    no_news_available: 'Tidak ada konten tersedia.',
    no_organizations_found: 'Tidak ada organisasi ditemukan.',
    no_spaces_found: 'Tidak ada ruang ditemukan.',
    no_spaces_found_create_first: 'Tidak ada ruang ditemukan. Buat ruang pertama Anda untuk mulai mempublikasikan konten.',
    ...
    published_news: 'Konten yang Diterbitkan',
    ...
    join_to_see_published_news: 'Bergabung untuk Melihat Konten yang Diterbitkan',
    become_member_to_access_news: 'Menjadi anggota organisasi ini untuk melihat dan mengakses semua artikel konten yang diterbitkan.',
    ...
    back_to_news: 'Kembali ke Konten',
    create_news: 'Buat Konten',
    space: 'Ruang',
    select_a_space: 'Pilih ruang',
    caption: 'Keterangan',
    optional_caption_for_the_image: 'Keterangan opsional untuk gambar',
    content: 'Konten',
    write_your_news_content_here: 'Tulis konten Anda di sini...',
    status: 'Status',
    ...
    creating: 'Membuat...',
    create_news_button: 'Buat Konten',
    you_are_not_a_member: 'Anda bukan anggota organisasi ini.',
    failed_to_create_news: 'Gagal membuat konten',
    back_to_organization: 'Kembali ke Organisasi',
    all: 'Semua',
    draft: 'Draf',
    need_review: 'Perlu Ditinjau',
    rejected: 'Ditolak',
    no_news_found_in_this_category: 'Tidak ada konten ditemukan di kategori ini.',
    in: 'di',
    review_notes: 'Catatan Tinjauan',
    publish: 'Terbitkan',
    reject: 'Tolak',
    failed_to_delete_news: 'Gagal menghapus konten',
    are_you_sure_delete_news: 'Apakah Anda yakin ingin menghapus konten ini?',
  ...
  en: {
    ...
    share_story_placeholder: 'Share a story or breaking content...',
    ...
    edited_by: 'edited by',
    published: 'Published',
    news_not_found: 'Content not found',
    ...
    failed_to_review_news: 'Failed to review content',
    ...
    no_spaces_found_create_first: 'No spaces found. Create your first space to start publishing content.',
    space_name: 'Space Name',
    description_optional: 'Description (Optional)',
    image_optional: 'Image (Optional)',
    update_space: 'Update Space',
    organization_not_found: 'Organization not found',
    published_news: 'Published Content',
    ...
    join_to_see_published_news: 'Join to See Published Content',
    become_member_to_access_news: 'Become a member of this organization to view and access all published content articles.',
    no_image: 'No image',
    ...
    user_role_editor: 'Editor',
    user_role_admin: 'Admin',
    back_to_news: 'Back to Content',
    create_news: 'Create Content',
    space: 'Space',
    select_a_space: 'Select a space',
    caption: 'Caption',
    optional_caption_for_the_image: 'Optional caption for the image',
    content: 'Content',
    write_your_news_content_here: 'Write your content here...',
    status: 'Status',
    save_as_draft: 'Save as Draft (you can edit later)',
    submit_for_review: 'Submit for Review (admins/editors will review)',
    creating: 'Creating...',
    create_news_button: 'Create Content',
    you_are_not_a_member: 'You are not a member of this organization.',
    failed_to_create_news: 'Failed to create content',
    back_to_organization: 'Back to Organization',
    all: 'All',
    draft: 'Draft',
    need_review: 'Need Review',
    rejected: 'Rejected',
    no_news_found_in_this_category: 'No content found in this category.',
    in: 'in',
    review_notes: 'Review Notes',
    publish: 'Publish',
    reject: 'Reject',
    failed_to_delete_news: 'Failed to delete content',
    are_you_sure_delete_news: 'Are you sure you want to delete this content?',
